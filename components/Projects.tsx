...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    task: "Сотрудники тратили время, ища ответы в документах, FAQ и переписке.",
    solution: "Ассистент с поиском по базе знаний: отвечает по регламентам и материалам компании в привычном чате.",
    result: "Быстрые ответы по утверждённым источникам вместо ручного поиска по файлам.",
